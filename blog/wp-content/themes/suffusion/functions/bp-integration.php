...
if (!function_exists('suffusion_bp_custom_background')) {
	add_filter('body_class', 'suffusion_bp_custom_background', 15, 2);

	/**
	 * BuddyPress kills the "custom-background" class, thereby rendering the custom background useless. This is to reintroduce the custom-background class, if appropriate.
	 *
	 * @param array $classes
	 * @param string $class
	 * @return array
	 */
	function suffusion_bp_custom_background($classes = array(), $class = '') {
