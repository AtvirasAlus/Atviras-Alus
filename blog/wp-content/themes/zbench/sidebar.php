<div id="sidebar-border">
	<div id="rss_border">
		<div class="rss_border">
			<div id="rss_wrap">
				<div class="rss_wrap">
					<?php $options = get_option('zBench_options'); $rss_text='';
					if($options['twitter_url'] == '' && $options['facebook_url'] == '' && $options['googleplus_url'] == '') $rss_text='rss_text'; ?>
					<a class="rss <?php echo $rss_text;?>" href="<?php if($options['rss_url'] <> '') { echo($options['rss_url']); } else { bloginfo('rss2_url'); } ?>" rel="nofollow" title="<?php _e('RSS Feed', 'zbench'); ?>"><?php _e('RSS Feed', 'zbench'); ?></a>
					<?php if($options['twitter_url'] <> '') : ?>
					<a class="twitter" href="<?php echo($options['twitter_url']); ?>" rel="nofollow" title="<?php _e('Follow me on twitter.', 'zbench'); ?>"><?php _e('Follow me on twitter.', 'zbench'); ?></a>
					<?php endif; ?>
					<?php if($options['facebook_url'] <> '') : ?>
					<a class="facebook" href="<?php echo($options['facebook_url']); ?>" rel="nofollow" title="<?php _e('Facebook', 'zbench'); ?>"><?php _e('Facebook', 'zbench'); ?></a>
					<?php endif; ?>
					<?php if($options['googleplus_url'] <> '') : ?>
					<a class="googleplus" href="<?php echo($options['googleplus_url']); ?>" rel="nofollow" title="<?php _e('Google+', 'zbench'); ?>"><?php _e('Google+', 'zbench'); ?></a>
					<?php endif; ?>
				</div>
			</div>
		</div>
