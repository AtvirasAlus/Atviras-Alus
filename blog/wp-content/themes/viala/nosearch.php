...
<div class="wrap">
  <div id="errorpost" class="nonet">	
	...
	<div class="posttitle">
		<h2><?php _e('Sorry!','ml');?></h2>
	</div>
	<div class="entry">
		<p><?php _e('We couldn\'t find anything that matched','ml');?><strong><?php echo ' &#8220' .$s. '.&#8221';?></strong></p>
<p><?php _e('Try again, but this time: double-check your spelling, try different search terms, or try using fewer or more general search terms.','ml');?></p>
...
<?php
					...
					if (!$send) { ?>
						...
						<div class="contact-form nosearch">
